---
title: "WordPress 自动本地化外链图片的实现方式"
date: 2021-06-25
slug: wp-auto-save-remote-images
description: "记录一种在 WordPress 中自动下载并本地化外链图片的实现方案，并分析在 Hugo 静态博客体系下的替代思路。"
categories:
  - 工作
summary: "记录一种在 WordPress 中自动下载并本地化外链图片的实现方案，并分析在 Hugo 静态博客体系下的替代思路。"
aliases:
  - /about-work/157.html
---

在使用 WordPress 写作时，经常会遇到一个问题：

> 文章中引用了外部图片，一旦原站删除或防盗链，文章内容就会失效。

为了解决这个问题，当年我在 WordPress 中实现了一套**自动本地化外链图片**的方案。
